...
badd +1 Element.php
badd +1 Event.php
badd +1 EventsPage.php
badd +1 Page.php
badd +1 VacanciesPage.php
badd +1 Vacancy.php
badd +1 HomePage.php
badd +1 ../../contactPage/code/ContactPage.php
silent! argdel *
edit Element.php
...
1
normal! 0
tabedit ../../contactPage/code/ContactPage.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 137 - ((27 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
